...
const CopyPageMarkdown: QuartzComponent = ({ fileData, displayClass }: QuartzComponentProps) => {
  ...
  return (
    <div class={classNames(displayClass, "copy-page-container")}>
      <button class="copy-page-button" data-slug={slug} aria-label="Copy page as Markdown">
        <svg
          aria-hidden="true"
          height="16"
          viewBox="0 0 16 16"
        ...
        <span class="copy-page-text">Copy page</span>
        <svg
      ...
      <div class="copy-page-dropdown">
        <button class="dropdown-item copy-markdown-btn" data-slug={slug}>
          ...
          <div class="dropdown-item-content">
            <span class="dropdown-item-title">Copy page as Markdown</span>
          </div>
        </button>
        <a class="dropdown-item view-markdown-link external" href={`/${slug}/llms.txt`} target="_blank" data-no-popover="true">
          <svg
            aria-hidden="true"
            height="16"
            viewBox="0 0 16 16"
        ...
        >
          ...
          <div class="dropdown-item-content">
            <span class="dropdown-item-title">Ask Honcho about this page <span class="external-arrow">↗</span></span>
          </div>
        </a>
        <a
        ...
        >
          ...
          <div class="dropdown-item-content">
            <span class="dropdown-item-title">Ask ChatGPT about this page <span class="external-arrow">↗</span></span>
          </div>
        </a>
        <a
        ...
        >
          ...
          <div class="dropdown-item-content">
            <span class="dropdown-item-title">Ask Claude about this page <span class="external-arrow">↗</span></span>
          </div>
        </a>
      </div>
    </div>
