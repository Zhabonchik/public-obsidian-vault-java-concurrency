...
const GitHubIcon = () => (
  <svg class="rail-social-icon" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
...
const links = [
  { href: "mailto:komeno@riceset.com", label: "Email", Icon: MailIcon },
  { href: "https://github.com/riceset", label: "GitHub", Icon: GitHubIcon },
  { href: "https://www.linkedin.com/in/riceset/", label: "LinkedIn", Icon: LinkedInIcon },
  { href: "https://www.youtube.com/@riceset", label: "YouTube", Icon: YouTubeIcon },
  { href: "https://www.instagram.com/riceset/", label: "Instagram", Icon: InstagramIcon },
  { href: "https://x.com/riceset", label: "X", Icon: XIcon },
...
export default (() => Socials) satisfies QuartzComponentConstructor
